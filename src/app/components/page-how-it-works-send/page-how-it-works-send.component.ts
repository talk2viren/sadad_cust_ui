...
@Component({selector: "app-page-how-it-works-send", templateUrl: "./page-how-it-works-send.component.html", styleUrls: ["./page-how-it-works-send.component.scss"]})
export class PageHowItWorksSendComponent implements OnInit {
  constructor() {}
