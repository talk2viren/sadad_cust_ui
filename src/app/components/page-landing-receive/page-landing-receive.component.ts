...
@Component({selector: "app-page-landing-receive", templateUrl: "./page-landing-receive.component.html", styleUrls: ["./page-landing-receive.component.scss"]})
export class PageLandingReceiveComponent implements OnInit {
  constructor() {}
