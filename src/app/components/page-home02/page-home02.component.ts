...
@Component({selector: "app-page-home02", templateUrl: "./page-home02.component.html", styleUrls: ["./page-home02.component.scss"]})
export class PageHome02Component implements OnInit {
